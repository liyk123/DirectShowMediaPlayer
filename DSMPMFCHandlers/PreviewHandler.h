...
#include <afxext.h>
#include "..\DSMPMFC\DSMPMFCDoc.h"
#include "..\DSMPMFC\DSMPMFCView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CDSMPMFCView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CDSMPMFCDoc, (CObject*) m_pDocument->GetContainer());
